...
(declare-function treesit-fold-range-julia "treesit-fold.el")
...
(defun treesit-fold-parsers-julia ()
  ...
  '((block_comment       . (treesit-fold-range-seq 1 -1))
    ...
    (function_definition . treesit-fold-range-julia)
    (if_statement        . (treesit-fold-range-seq 1 -2))
    (let_statement       . (treesit-fold-range-seq 2 -2))
    (macro_definition    . treesit-fold-range-julia)
    (module_definition   . treesit-fold-range-julia)
    (quote_statement     . treesit-fold-range-julia)
    (struct_definition   . treesit-fold-range-julia)
    (triple_string       . (treesit-fold-range-seq 2 -2))
    (try_statement       . (treesit-fold-range-seq 2 -2))
    (while_statement     . treesit-fold-range-julia)))
